...
/** 将弹层锚在选区附近，并限制在中间文档 Canvas（contentRef）可视区域内 */
...
): Promise<{ boxes: import('./playground-types').BoundingBox[]; resultImage?: string }> {
