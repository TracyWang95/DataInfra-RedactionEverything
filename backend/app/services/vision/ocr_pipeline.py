...
PP-StructureV3 extraction), ocr_block_merge (block merging), ocr_seal_split
(stacked-seal splitting), ocr_table_semantics (HTML table expansion +
...
from app.services.vision.ocr_seal_split import (
    _split_merged_seal_region,
)
