...
TYPE_REGISTRY: dict[str, dict] = {
    "ADDRESS": {"cn": "地址", "label": "地址", "groups": ["address_like"], "id_aliases": ["POSTAL_CODE"], "cn_terms": ["住址", "地址", "居住地", "收货地址", "详细地址", "通信地址"]},
    ...
    "DOCUMENT_NUMBER": {"cn": "文书编号", "label": "文书编号", "groups": ["identifier_like"], "id_aliases": ["LEGAL_CASE_ID", "LEGAL_DOC_NO"], "cn_terms": ["执行案号", "文书号", "文书编号", "案件号", "案号", "法律文书号", "裁判文书编号"]},
